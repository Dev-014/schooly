...
class TeacherNoticeCreate extends StatefulWidget {
  const TeacherNoticeCreate({Key? key}) : super(key: key);

  @override
  State<TeacherNoticeCreate> createState() => _TeacherNoticeCreateState();
}

class _TeacherNoticeCreateState extends State<TeacherNoticeCreate> {
