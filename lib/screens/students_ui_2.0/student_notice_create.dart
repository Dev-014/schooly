...
class StudentNoticeCreate extends StatefulWidget {
  const StudentNoticeCreate({Key? key}) : super(key: key);

  @override
  State<StudentNoticeCreate> createState() => _StudentNoticeCreateState();
}

class _StudentNoticeCreateState extends State<StudentNoticeCreate> {
          ...
          Expanded(
            child: StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                List<dynamic> notices = snapshot.data!['notice'] ?? <dynamic>[];
