...
class NoticeBoardPage1 extends StatefulWidget {
  const NoticeBoardPage1({Key? key}) : super(key: key);

  @override
  _NoticeBoardPage1State createState() => _NoticeBoardPage1State();
}

class _NoticeBoardPage1State extends State<NoticeBoardPage1> {
