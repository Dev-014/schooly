...
class TimeTableService {
  static Future<void> uploadTimetableDataToFirestore(
      {required FilePickerResult result, required String clazz, required String section}) async {
    ...
    CollectionReference timetableCollection = firestore.collection(
 ...
 static String generateRandomDocId() {
