...
class LoaderIconTextButton extends StatefulWidget {
  final String text;
  final IconData icon;
  final Future<dynamic> Function() onPressed;
   LoaderIconTextButton({required this.text,required this.icon,required this.onPressed,super.key});

  @override
  State<LoaderIconTextButton> createState() => _LoaderIconTextButtonState();
}
